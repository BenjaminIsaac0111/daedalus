...
def main(configuration):
    ...
    start_population_size = len(pd.read_csv(paths.path_to_pop_file))
    ...
    # mortality_rate_df = pd.read_csv(paths.path_to_mortality_file)
    ...
    # fertility_rate_df = pd.read_csv(paths.path_to_fertility_file)
    ...
    # df_emigration = pd.read_csv(paths.path_to_emigration_file)
    # df_total_population = pd.read_csv(paths.path_to_total_population_file)
    ...
    # df_immigration = pd.read_csv(paths.path_to_immigration_file)
