...
setup(name='daedalus',
      ...
      install_requires=['distutils_pytest', 'vivarium',
                        ...
                        'vivarium_public_health @ git+https://github.com/alan-turing-institute/vivarium_public_health_spenser.git@feature/48-OD-matrices-new#egg=vivarium_public_health_spenser'],
